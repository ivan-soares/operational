...
#############################################################################################################
	...
	echo
	echo " +++ Starting bash program to make input files to run ww3_multi +++ "
	echo
...
echo; echo " +++ Make ww3_prnc.inp +++"; echo
...
echo; echo " +++ Make ww3_multi.inp +++"; echo
...
EOF
  ...
  if [ $buoy == 'points' ]; then
    cat $inpdir/buoy.loc >> ww3_multi.inp
  fi
...
echo
echo " +++ End of bash program to make input files to run ww3_multi +++ "
echo
