...
#
	...
	echo " ... make inputs for WW3 at $now" >> $log; echo >> $log
	echo " ==> $now HERE I am @ $dr for step 06: make input files for WW3 <=="; echo
	#====================================================================================
...
echo " ... finished input files for WW3 at $now" >> $log; echo >> $log
echo " ==> $now FINISHED making input files for WW3 <=="; echo
#=======================================================================
