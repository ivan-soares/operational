...
print(' ')
print(' +++> STARTING python program to write OGCM vars  <+++ ')
print(' ')
...
time = inpfile.variables['time'][:]
time = (time - time[0])

lon = inpfile.variables['lon'] [0,:]
lat = inpfile.variables['lat'] [:,0]
prf = inpfile.variables['depth'][:]
...
print(' ')
print(' +++> END of python program to write OGCM vars <+++ ')
print(' ')
