...
u2d = inpfile.variables['uo'][dtime,0,:,:]
v2d = inpfile.variables['vo'][dtime,0,:,:]
...
tit = 'NEMO surface currents on ' + today
fig = 'nemo_sfc_vels_' + today + '_bcampos.png'
wesn = [-47, -39, -27, -22]
...
tit = 'NEMO surface currents on ' + today
fig = 'nemo_sfc_vels_' + today + '_norte.png'
