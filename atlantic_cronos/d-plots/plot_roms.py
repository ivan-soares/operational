...
u2d = inpfile.variables['u_eastward'][dtime,29,:,:]
v2d = inpfile.variables['v_northward'][dtime,29,:,:]
...
tit = 'ROMS+' + ogcm + ' surface currents on ' + today
fig = 'roms+' + ogcm + '_sfc_vels_' + today + '_bcampos.png'
wesn = [-47, -39, -27, -22]
...
tit = 'ROMS+' + ogcm + ' surface currents on ' + today
fig = 'roms+' + ogcm + '_sfc_vels_' + today + '_norte.png'
